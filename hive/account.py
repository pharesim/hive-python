...
class Account(dict):
    ...
    def get_balances(self):
        ...
        totals = {
            'HIVE':
                sum([available['HIVE'], savings['HIVE'], rewards['HIVE']]),
            'HBD':
                sum([available['HBD'], savings['HBD'], rewards['HBD']]),
            'VESTS':
    ...
    def _get_followers(self, direction="follower", last_user=""):
        if direction == "follower":
            ...
            followers = self.hived.get_followers(self.name, last_user, "blog",
                                                  100)
        elif direction == "following":
            followers = self.hived.get_following(self.name, last_user, "blog",
                                                  100)
